    ...
    <section class="content">
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Список всех ссылок</h3>
            ...
            <div class="card-body">
                <a href="{{ route('video.create') }}" class="btn btn-primary mb-3"> Добавить ссылок</a>
