                ...
                <div class="row">
                    ...
                    <div class="col-md-10">
                        ...
                        <div class="card card-primary">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form method="post" role="form" action="{{route('document.store')}}" enctype="multipart/form-data">
                                @csrf
                                <div class="card-body">
                                ...
                                <div class="card-footer">
                                    <button type="submit" id="btn-action" class="btn btn-primary">Добавить документ</button>
                                </div>
                            </form>
                        </div>
                        <!-- /.card -->
