            ...
            <nav class="sidebar_menu">
                <ul class="sidebar_menu__items">
                    ...
                    <li class="sidebar_menu__item sidebar_menu__item--parent sidebar_menu__item">
                        <a href="#">Мониторинги</a>
                        <button type="button"><i class="fas fa-caret-down"></i></button>
                        <ul class="sidebar_submenu sidebar_submenu--active">
                            <li class="sidebar_submenu__item"><a href="">Мониторинг 2021</a></li>
                            <li class="sidebar_submenu__item"><a href="">Мониторинг 2020</a></li>
                            <li class="sidebar_submenu__item"><a href="">Мониторинг 2019</a></li>
                            <li class="sidebar_submenu__item"><a href="">Мониторинг 2018</a></li>
