...
class VideoController extends Controller
{
    ...
    {
        $posts = Post::where('type_id','3')->orderBy('created_at', 'desc')->paginate(15);
        $categories = DB::select('SELECT * FROM categories');
        return view('admin.posts.video.index',compact('posts','categories'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.posts.video.create',compact('categories','types','departments'));
    }
